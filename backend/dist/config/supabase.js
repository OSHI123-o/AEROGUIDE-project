...
export function getSupabaseAdmin() {
    ...
    if (!env.supabaseUrl || !env.supabaseServiceRoleKey) {
        throw new Error("SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY must be set in .env for admin client");
    }
...
export function getSupabaseClient() {
    ...
    if (!env.supabaseUrl || !env.supabaseAnonKey) {
        throw new Error("SUPABASE_URL and SUPABASE_ANON_KEY must be set in .env for public client");
    }
